package com.sears.services.commercial.bl.impl;


import com.sears.search.log.util.LogUtil;
import com.sears.search.util.SolrUtil;
...
import com.sears.services.commercial.bl.DelegateInitializer;
import com.sears.services.commercial.bl.QueryService;
import com.sears.services.commercial.bl.processor.Delegate;
import com.sears.services.commercial.bl.task.QueryCommand;
...
public class QueryServiceImpl implements QueryService {
    ...
    @Cacheable(cacheNames = "default", key = "#serviceRequest.cacheKey", condition = "#serviceRequest.from != T(com.sears.search.service.api.response.From).INDEX", unless = "T(com.sears.services.commercial.util.MiscUtil).isValidResponse(#result) == false")
