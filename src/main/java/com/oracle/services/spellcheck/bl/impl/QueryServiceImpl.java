package com.oracle.services.spellcheck.bl.impl;
...
import com.oracle.services.spellcheck.bl.task.QueryCommand;
import com.oracle.services.spellcheck.util.LogUtil;
import com.oracle.services.spellcheck.util.SolrUtil;
import com.oracle.services.spellcheck.bl.DelegateInitializer;
import com.oracle.services.spellcheck.bl.processor.Delegate;
...
public class QueryServiceImpl implements QueryService {
    ...
    @Cacheable(cacheNames = "default", key = "#serviceRequest.cacheKey", condition = "#serviceRequest.from != T(com.sears.search.service.api.response.From).INDEX", unless = "T(com.oracle.services.spellcheck.util.MiscUtil).isValidResponse(#result) == false")
